...
public class AuthController {
    ...
    public Response<AuthVo> loginByWeixin(@RequestBody AuthDTO authDTO) {
        ...
        if (!wxUserService.checkUserInfo(sessionKey, detail.getRawData(), detail.getSignature())) {
            String message = "userInfo 和 session 中的不一致===================="+authDTO.getCode();
            log.info(message);
        ...
        System.err.println(vo.getToken());
    ...
    @PostMapping("/loginByWeixin2")
    public Response<AuthVo> loginByWeixin2(@RequestBody AuthDTO authDTO) {
